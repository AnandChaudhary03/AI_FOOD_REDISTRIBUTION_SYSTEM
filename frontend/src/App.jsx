...
import BusinessBarcode from './pages/business/Barcode.jsx'
...
export default function App() {
  return (
    <QueryClientProvider client={queryClient}>
      <AuthProvider>
        <BrowserRouter>
          <Toaster position="top-right" toastOptions={{ style: { background: '#152035', color: '#fff', border: '1px solid #1e3a5f' } }} />
          <Routes>

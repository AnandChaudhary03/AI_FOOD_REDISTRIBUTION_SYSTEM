...
// Pages (Static Imports for 100% Instant & Reliable Loading)
...
import WastePrediction from './pages/business/WastePrediction.jsx'
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/business" element={<ProtectedRoute role="business"><BusinessLayout /></ProtectedRoute>}>
              ...
              <Route path="forecasting" element={<WastePrediction />} />

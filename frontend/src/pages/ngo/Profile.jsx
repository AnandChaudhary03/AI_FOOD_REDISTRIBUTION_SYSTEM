  ...
  return (
    <div className="page fade-in">
      <div className="page-header">
        ...
        <p className="page-subtitle">NGO organizational details and verification badge</p>
      </div>
      ...
      <div style={{ maxWidth: '600px' }} className="card">
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
          ...
          <div>
            ...
            <span className="badge badge-green" style={{ marginTop: '0.25rem' }}>
              <ShieldCheck size={12} /> Verified Non-Profit NGO
            </span>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem', background: 'var(--bg-secondary)', borderRadius: 'var(--radius)' }}>
            ...
            <div>
              <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Representative Name</div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem', background: 'var(--bg-secondary)', borderRadius: 'var(--radius)' }}>
            ...
            <div>
              ...
              <div style={{ fontWeight: 600 }}>{user?.phone || '+91 98765 00000'}</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem', background: 'var(--bg-secondary)', borderRadius: 'var(--radius)' }}>
            ...
            <div>
              ...
              <div style={{ fontWeight: 600 }}>{user?.address || 'Lajpat Nagar, New Delhi'}</div>
            </div>
          </div>
        </div>
      </div>
